 ...
 * <p>
 * While the timer value greater than 0, the cell that used to be Pickup_Trap will not award
 * the speed powerup.
 *
 ...
 * @see Pickup_Trap
 */
public class Pickup_Trap_Inactive extends Cell implements Timer {
    int timer = 0;
    ...
    private void paramList() {
        this.cellEnum = CellType.Pickup_Trap_Inactive ;
        this.setTimer();
    }
     ...
     */
    public Pickup_Trap_Inactive(GroundType setGround, Pair<Integer, Integer> setPosition, MapManager setManager) {
        this.paramList();
    ...
    /**
     * Sets the timer attribute to 60*60
     */
    @Override
    ...
    /**
     * Updates this cell position within the CellArray to contain a Pickup_Trap
     * cell again
     * <p>
     * Removes the old Pickup_Trap cell from ResetHandler within MapManager
     */
    @Override
    public void timerMethod() {
        MapManager.cellArray[cellPosition.getKey()][cellPosition.getValue()] =
                new Pickup_Trap(groundEnum, cellPosition, mapManager);
